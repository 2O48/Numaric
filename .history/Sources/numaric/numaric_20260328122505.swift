...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    private var hotKeyLabelField: NSTextField?
    ...
    func applicationDidFinishLaunching(_ notification: Notification) {
        // Create an invisible main window to trigger permission prompts
        mainWindow = NSWindow(
    ...
    private func makeSettingsWindow() -> NSWindow {
        ...
        let labelField = NSTextField(labelWithString: "当前切换键：\(hotKeyLabel())")
        labelField.translatesAutoresizingMaskIntoConstraints = false
        hotKeyLabelField = labelField
        ...
        NSLayoutConstraint.activate([
            ...
            labelField.leadingAnchor.constraint(equalTo: title.leadingAnchor),
            labelField.topAnchor.constraint(equalTo: title.bottomAnchor, constant: 10),
            ...
            help.topAnchor.constraint(equalTo: labelField.bottomAnchor, constant: 10),
